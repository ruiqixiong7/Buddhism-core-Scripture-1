...
‘The sea of suffering has no shore; only self-rescue is possible.’

‘All conditioned phenomena are like dreams, illusions, bubbles, and shadows; like dewdrops and 
lightning flashes.’
...
Run all cells in the notebook to see the interactive sketch.
...
- **Libraries**:
  - py5canvas
  - py5
  - numpy (if used in your Notebook)
